...
% Sweep parameters
InputStruct.N_list = [50];     % Trap nums to optimize
InputStruct.diff_thresh = 1e-4;  % Improvements smaller than this value are considered converged
...
% File name
InputStruct.log_dir = ['Ellipse\LogFiles\Log_eps0p', num2str(1000*epsilon, 3), '0-ecc0p', num2str(1000*ecc, 3)];
